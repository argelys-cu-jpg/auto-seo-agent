...
const envSchema = z.object({
    ...
    STRAPI_FIELD_MAPPING_JSON: z
        .string()
        .default('{"title":"title","slug":"slug","excerpt":"excerpt","body":"body","seoTitle":"seo_title","metaDescription":"meta_description","schema":"schema_json","tags":"tags","category":"category","featuredImage":"featured_image","publishStatus":"publishedAt"}'),
