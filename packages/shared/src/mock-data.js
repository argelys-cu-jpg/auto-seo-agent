export const mockTopicCandidates = [
    {
        ...
        explanation: "High commercial intent and strong relevance to CookUnity with manageable difficulty and room for differentiation on chef-driven positioning.",
    ...
    },
    {
        ...
        recommendation: "write_now",
        explanation: "Cuisine-specific intent aligns with CookUnity menu discovery and supports a larger healthy-eating cluster.",
...
export const mockBrief = {
    ...
    intentSummary: "Searchers are comparing healthy meal delivery options and want practical guidance on quality, ingredients, convenience, and customization.",
    differentiators: [
...
export const mockDraft = {
    ...
    intro: "Healthy prepared meal delivery can save time, but not every service balances convenience, ingredient quality, and variety the same way.",
    keyTakeaways: [
        "Use the article to help readers compare options on quality, convenience, and variety.",
        "Keep internal links tied to category education and conversion-adjacent discovery.",
        "Close with a realistic CookUnity CTA instead of a hard-sell claim.",
    ],
    sections: [
        {
    ...
    imagePlan: {
        headerImageTerm: "healthy prepared meal delivery",
        sectionImages: [
            { header: "Key takeaways", searchTerm: "prepared meals" },
            { header: "What healthy prepared meal delivery should actually offer", searchTerm: "healthy prepared meals" },
        ],
    },
    publishPackage: {
        slug: "healthy-prepared-meal-delivery-guide",
        description: "Compare options, quality signals, and what to look for in healthy prepared meal delivery before you choose a service.",
        blocks: [{ __component: "shared.rich-text", body: "<p>Mock body</p>" }],
...
export const mockOptimizationTask = {
